...
//        List<ProductResponse.DTO> dtoList = new ArrayList<>();
//        for (Product p : products) {
//            dtoList.add(new ProductResponse.DTO(p));
//        }

//        for (ProductResponse.DTO dto : dtoList) {
...
//        }
        ...
        System.out.println("5. 상품 상세 화면 (p1)");

        ProductDetailDTO productDetailDTO = new ProductDetailDTO(p1Options);
        String r2 = gson.toJson(productDetailDTO);
        System.out.println(r2);

//        ProductResponse.DetailDTO detailProductDTO = new ProductResponse.DetailDTO(p1Options);
//        System.out.println(detailProductDTO);
        ...
        OrderDetailV2DTO orderDetailDTO = new OrderDetailV2DTO(or1Options);
        String r3 = gson.toJson(orderDetailDTO);
        System.out.println(r3);

//        OrderResponse.DetailDTO detailOrderDTO2 = new OrderResponse.DetailDTO(or1Options);
//        System.out.println(detailOrderDTO2);
    }
}